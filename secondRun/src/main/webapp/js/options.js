var teslaThemes = {
	...
	loginPopup: function () {
		...
		var loginLink = jQuery('header .right-block p a.login'),
			termsLink = jQuery('header .right-block p a.register'),
			termsBtn = jQuery('#login-popup .register-link .register-btn'),
		  agreementBtn = jQuery('.Agreement-terms #Agreement1-Btn, .Agreement-terms #Agreement2-Btn, .Agreement-terms #Agreement3-Btn'),
		  agreementAllBtn = jQuery('.Agreement-terms #AgreementAll-Btn'),
			registerBtn = jQuery('.Agreement .Agreement-nav .Agreement-nav__btn'),
		...
		loginLink.on('click', function (e) {
			e.preventDefault();
			jQuery('#login-popup').css("max-width", "300px");
			jQuery('#login-popup').find('#login-form').show();
			jQuery('#login-popup').find('#login-footer').show();
			jQuery('#login-popup').find('#terms-form').hide();
		...
		// Show Terms Form in registerForm
		termsLink.on('click', function (e) {
			e.preventDefault();
			
			agreementAllBtn.prop('checked', false);
      agreementBtn.prop('checked', false);
      jQuery('.Agreement-nav #AgreementNext-Btn').addClass('btn-default');
      jQuery('.Agreement-nav #AgreementNext-Btn').prop('disabled', true);
      
			jQuery('.Account-title').css("margin-top", "0px");
			jQuery('.Account-title').css("margin-bottom", "0px");
			jQuery('#login-popup').css("max-width", "520px");
			jQuery('#login-popup').find('#login-form').hide();
			jQuery('#login-popup').find('#register-form').hide();
			jQuery('#login-popup').find('#login-footer').hide();
			jQuery('#login-popup').find('#terms-form').show();
      ...
      jQuery('#login-popup').find('#terms-form').show();
		...
		//agreementBtn enable/disable
		agreementBtn.on('change', function (e) {
		  if(jQuery('.Agreement-terms #Agreement1-Btn').is(':checked') &&
		      jQuery('.Agreement-terms #Agreement2-Btn').is(':checked') &&
		      jQuery('.Agreement-terms #Agreement3-Btn').is(':checked')) {
		    agreementAllBtn.prop('checked', true);
		    jQuery('.Agreement-nav #AgreementNext-Btn').removeClass('btn-default');
		    jQuery('.Agreement-nav #AgreementNext-Btn').prop('disabled', false);
		  }else {
		    agreementAllBtn.prop('checked', false);
		    jQuery('.Agreement-nav #AgreementNext-Btn').addClass('btn-default');
		    jQuery('.Agreement-nav #AgreementNext-Btn').prop('disabled', true);
		...
		//agreementAllBtn enable/disable
		agreementAllBtn.on('change', function (e) {
      if(agreementAllBtn.is(':checked')) {
        agreementBtn.prop('checked', true);
        jQuery('.Agreement-nav #AgreementNext-Btn').removeClass('btn-default');
        jQuery('.Agreement-nav #AgreementNext-Btn').prop('disabled', false);
      }else {
        agreementBtn.prop('checked', false);
